...
export default function DistrictInfoContainer({ districtName, onClose }: DistrictInfoContainerProps) {
    ...
    return (
        <>
            ...
            <div className="slide-in-right w-72 bg-white text-zinc-900 rounded-xl overflow-hidden shadow-xl border border-zinc-200">
                ...
                <div className="h-0.5 bg-gradient-to-r from-[rgb(247,100,94)] via-[rgb(247,140,100)] to-transparent" />
            </div>
        </>
    );
}